...
public class FileFactory {
    ...
    public static boolean servletFileUpload(HttpServletRequest _request, String _acceptExtension) {
                ...
                for (FileItem item : formItems) {
                    if (!item.isFormField()) {
                        ...
                        if (extensionValidCheck(extension, _acceptExtension)) {
                            String filePath = uploadPath + File.separator + getMD5(new File(item.getName())) + "." + extension;
