...
<html lang="en">
    ...
    <body>
                        ...
                        <div class="collapse nav-toggleable-md" id="nav-toggleable-md">
                            ...
                            <ul class="nav nav-pills nav-stacked flex-column">
                                ...
                                <div id="main_panel" class="nav-item">
                                    ...
                                    %>
                                    <li class="nav-item">
                                        <a class="nav-link" href="Search?code=URSR" style="color: inherit;">Account Page</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link " href="Acc?code=Logoff">Logoff</a>
                                    </li>
                                    <%
                                    } else {
                                    %>
                                    <li class="nav-item">
                                        <a class="nav-link " data-toggle="modal" data-toggle="modal" data-target="#login-modal">Login</a>
                                    </li>
                                    <%
                                        }
                                    %>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 mb" style="margin-bottom: 50px">
                                ...
                                <div style="text-align: center">
                                    <a href="Search?code=STSR&category=<%= i + 1%>&page=0" class="btn btn-outline-primary px-3">See More</a>
                ...
                <div class="modal-content" style="
                    ...
                    <form action="Acc" method="post" id="loginForm" name="login" role="form"  onclick="validation();">
                        ...
                        <div class="modal-footer">			
                            ...
                            <input type="submit" class="btn btn-success" id="submit" disabled="true">
                        </div>
                    </form>
        ...
        <script>
            function validation() {
                var inputEmail, inputPassword, responseEmail = "";
